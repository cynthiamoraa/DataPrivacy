...
app.post("/", (req, res) => {
  ...
  if (text === "") {
    ...
    2. drop off`;
      ...
      response = `CON your parcel will be available for pick up at the nearest post office`;
    } else if (text === "1*" + otp + "*1*1*") {
      response = `CON your parcel will be delivered to your doorstep`;
    } else if (text === "1*" + otp + "*1*1*1") {
      response = `CON your parcel will be available for pick up at the nearest post office`;
